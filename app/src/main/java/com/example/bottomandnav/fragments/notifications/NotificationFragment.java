...
public class NotificationFragment extends BottomSheetDialogFragment {
    ...
    private void loadMenuData() {
        ...
        if (menuList!=null &&! menuList.isEmpty()) {
            testAdapter = new TestAdapter(getContext(), menuList, new TestAdapter.OnItemClickListener() {
                @Override
...
//         ChildSheet childMenuBottomSheet = new ChildSheet(item.children);
//         childMenuBottomSheet.show(getChildFragmentManager(), childMenuBottomSheet.getTag());
