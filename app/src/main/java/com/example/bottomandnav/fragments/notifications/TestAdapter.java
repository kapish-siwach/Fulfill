...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.ParentViewHolder> {
    Context context;
    ...
    public TestAdapter(Context context, List<ResponseModel.Menu> menuList, OnItemClickListener onItemClickListener) {
